 ...
 <div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-gift"></i>Coupon</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="coupon_list.php" class="dropdown-item">List</a>
                    <a href="coupon_create.php" class="dropdown-item">Add New</a>
                </div>
            </div>
            <!-- <div class="nav-item dropdown">
